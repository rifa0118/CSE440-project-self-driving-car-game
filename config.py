...
# Static obstacles scattered around the track during training/manual/watch modes.
# Each spawned obstacle is randomly assigned one of these visual kinds so the
# track doesn't just look like a row of identical parked cars.
OBSTACLE_KINDS: tuple[str, ...] = ("cone", "barrel", "barrier", "rock", "crate")

# Selectable values for the "Obstacles" setting (how many obstacles to place).
OBSTACLE_COUNT_CHOICES: tuple[int, ...] = (0, 2, 3, 5, 8, 12)
